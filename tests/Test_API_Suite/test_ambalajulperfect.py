...
from sites.ambalajulperfect_scraper import scraper as ambalajulperfectScraper
import pytest
import allure
...
def get_job_details():
    ...
    """
    scraper_data = ambalajulperfectScraper()
    testutils = TestUtils()
...
@pytest.mark.API
def test_ambalajulperfect_job_count_api(get_job_details):
